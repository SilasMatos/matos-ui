...
## 10. Componentes registrados

Lista dos componentes já criados e registrados no registry.

| Componente       | Arquivo UI              | Demo                               | MDX                                          |
| ---------------- | ----------------------- | ---------------------------------- | -------------------------------------------- |
| `spotlight-card` | `ui/spotlight-card.tsx` | `examples/spotlight-card-demo.tsx` | `content/docs/components/spotlight-card.mdx` |

### spotlight-card

Entradas adicionadas em `registry-ui.ts`:
...
```ts
{
  ...
  files: [{ path: "ui/spotlight-card.tsx", type: "registry:ui" }],
},
```

Entradas adicionadas em `registry-examples.ts`:
...
```ts
{
  ...
  files: [{ path: "examples/spotlight-card-demo.tsx", type: "registry:example" }],
},
```

Subcomponentes exportados: `SpotlightCard`, `SpotlightCardHeader`, `SpotlightCardContent`, `SpotlightCardFooter`.
Variantes exportadas: `spotlightCardVariants`, `spotlightCardHeaderVariants`, `spotlightCardContentVariants`, `spotlightCardFooterVariants`.

## Todos os arquivos criados em mdx deve ter seus textos em ingles
