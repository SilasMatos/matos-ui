    ...
    <section aria-labelledby={labelId} className="mt-4">
      <h2 className="mb-1">
        <button
          ...
          onClick={onToggle}
          className="flex h-8 w-full items-center gap-2 rounded-md px-2 text-left outline-none transition-colors duration-260 hover:bg-muted/20 focus-visible:ring-2 focus-visible:ring-ring motion-reduce:transition-none"
        >
...
function MobileLink({
  ...
  return (
    <Link
      ...
      onClick={() => onNavigate?.()}
      className={cn(
        "relative flex h-9 min-w-0 items-center rounded-md px-3 text-sm font-medium outline-none transition-[background-color,color,transform] duration-260 ease-spring",
