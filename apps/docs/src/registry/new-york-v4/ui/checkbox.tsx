...
export const checkboxVariants = cva(
  [
    ...
    "transition-[background-color,border-color,box-shadow,transform] duration-300 ease-spring hover:border-ring/60 hover:bg-muted/40 active:scale-[0.98]",
  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="flex items-center justify-center transition-[opacity,transform] duration-300 ease-spring data-starting-style:scale-90 data-starting-style:opacity-0 data-ending-style:scale-90 data-ending-style:opacity-0"
      >
