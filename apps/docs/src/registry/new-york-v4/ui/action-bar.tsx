...
export const actionBarVariants = tv({
  base: [
    ...
    "not-prose fixed z-50 flex w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] flex-col gap-3 border sm:w-auto sm:max-w-[calc(100vw-3rem)] sm:flex-row sm:items-center",
