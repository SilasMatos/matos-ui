...
// The section settles in like any surface lifting one step: `liftVariants(1)`
// resolves to the `fast` tier through `motionForOffset`. `withReducedMotion`
// keeps the fade and drops the 4px.
const enter = liftVariants(1);
const enterReduced = withReducedMotion(enter);
...
export function FormSection({
  ...
  return (
    <motion.section
      ...
      variants={shouldReduceMotion ? enterReduced : enter}
      initial="hidden"
      animate="visible"
      style={{
